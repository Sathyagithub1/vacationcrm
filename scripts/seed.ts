...
async function main() {
  ...
  const WIDGETS = [
    {
      widgetType: "LEAD_COUNT" as const,
      title: "Total Leads",
      dataSource: "leads",
      size: "SMALL" as const,
    ...
    {
      widgetType: "FOLLOW_UP_DUE" as const,
    ...
    {
      widgetType: "CONVERSION_RATE" as const,
    ...
    {
      widgetType: "CALLBACK_DUE" as const,
      title: "Callbacks Due",
    ...
    {
      widgetType: "LEAD_BY_STAGE" as const,
      title: "Lead Trends",
      dataSource: "leads",
      size: "LARGE" as const,
    ...
    {
      widgetType: "LEAD_BY_SOURCE" as const,
      title: "Department Breakdown",
      dataSource: "leads",
      size: "LARGE" as const,
      position: { x: 6, y: 1, w: 6, h: 2 },
      config: { chartType: "pie", groupBy: "department" },
    },
  ];
